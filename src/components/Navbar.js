    ...
    <nav className="site-navigation">
          ...
          <ul className="nav-list">
              ...
              {profile && (
                <li className='nav-item'>
                  <a href={resumeUri} target="_blank" style={{textDecoration: 'none' ,color: 'rgba(0,0,0,.748)'}}>
                    Resume
                  </a>
                </li>
              )}
      ...
      <div className={`nav-list-mobile ${navState}`}>
        <ul>
          ...
          {profile && (
            <li  className='nav-item'>
              <a href={resumeUri} target="_blank" style={{textDecoration: 'none', fontWeight:'normal', color: 'rgba(0,0,0,.748)'}}>
              Resume
            </a>
            </li>
          )}
